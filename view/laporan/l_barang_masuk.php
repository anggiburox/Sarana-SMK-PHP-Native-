          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <a href="ps_masuk.php" type="button" class="btn btn-success">Print Semua</a>
...
?>
                      <tr>
                          ...
                          <td>
                            <a href="satuan_masuk.php?id=<?php echo $data['id'] ?>" class="btn btn-success"><span class="fa fa-file-pdf-o" aria-hidden="true"></span></a>
                          </td>
                        </tr>
                        <?php  
                              $no++;
