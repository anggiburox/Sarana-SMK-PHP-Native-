...
$sql  = "SELECT * FROM pinjam_barang
    ...
    INNER JOIN barang on detail_pinjam_barang.id_barang = barang.id_barang WHERE pinjam_barang.status = 'Dipinjam'";
...
?>
                 <tr>
                          ...
                          <td><a onclick="return confirm('Anda yakin ingin menghapus data ?')"; href="hapus.php?id_pinjam=<?php echo $data['id_pinjam'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                        </td>
                        </tr>
                        <?php  
                              $no++;
