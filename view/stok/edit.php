              ...
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php
                    include '../koneksi/config.php';
                    $data=mysqli_fetch_array(mysqli_query($db, "SELECT * FROM stok WHERE id_barang = '$_GET[id_barang]'"));
                    ?>
                    <form action="e_stok.php" method="POST" class="form-horizontal form-label-left input_mask">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input name="jml_keluar" required type="number" min="0" value="<?php echo$data['jml_keluar']?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12">Total Barang :</label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input name="total_barang" required type="number" min="0" value="<?php echo$data['total_barang']?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                          <a href="stok.php" class="btn btn-dark" type="submit">Kembali</a>
