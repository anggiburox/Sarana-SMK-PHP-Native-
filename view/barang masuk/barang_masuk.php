          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                     <a href="t_barang_masuk.php" type="button" class="btn btn-success">Tambah Data</a>
                  </div>
                  <div class="x_content">
...
if(isset($_GET['cari'])){
  $cari = $_GET['cari'];
  $sql = mysqli_query($db, "SELECT * FROM barang_masuk
    INNER JOIN barang on barang_masuk.id_barang = barang.id_barang
    INNER JOIN suplier on barang_masuk.id_suplier = suplier.barang_masuk where id_barang like '%$cari%' or nama_barang like '%$cari%' or tgl_masuk like '%$cari%' or jml_masuk like '%$cari%' or id_suplier like '%$cari%' or nama_suplier like '%$cari%'");
}else{
  $sql = mysqli_query($db, "SELECT * FROM barang_masuk
    INNER JOIN barang on barang_masuk.id_barang = barang.id_barang
